...
(function() {
    ...
    Section.prototype = {
        ...
        changeDeepLevel: function(){
            this.deep++;
        },

        ariaLevelHeading: function() {

            _setAriaLevelHeading(this.sections);
        }
    };
    ...
    var _setAriaLevelHeading = function(sections, idx) {
        ...
        _sectionHeadingRank = function(section) {
            var heading = section.heading;
            return isHeading(heading) ? _getHeadingElementRank(heading) : 1; // is this true? TODO: find a reference...
        },
    ...
    */
        ...
        _getHeadingElementRank = function(el) {
            ...
            if (elTagName == 'HGROUP') {
                ...
                return -parseInt(elTagName.substr(1),10);
            }
        },

        _lastSection = function(outlineOrSection) {
            return _arrayLast(outlineOrSection.sections);
        },

        _arrayLast = function(arr) {
            return arr[arr.length - 1];
        },

        currentOutlinee, currentSection, stack, linkCounter, rootDocument,

        walk = function(root, enter, exit) {
            var node = root;
            start: while (node) {
                enter(node);
                if (node.firstChild) {
    ...
    var HTML5Outline = function(start) {
        linkCounter = 0;
    ...
    function init() {
        HTML5Outline(document.body).ariaLevelHeading(true);
    }
    init();
})();
